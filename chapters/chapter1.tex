...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=0.7\textwidth]{img/intro/lymnaea_life_cycle.pdf}
...
Voltage-clamp and patch clamping modified the paradigm in physiology and basic medicine in the study of the cell membrane dynamics with an exceptional detail that still today is heading ranges of precise recording and stimulation \parencite{hamill_improved_1981} . To Voltage-clamp followed variations such as dynamic-clamp, where the recording is not only ---
