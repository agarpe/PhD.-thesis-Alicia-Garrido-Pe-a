...
In this thesis, we explore the neural system of the great pond snail, \textit{Lymanea stagnalis} (see Fig. \ref{fig:lymnaea_life_cycle}a). This mollusk has been an important case study since the late XX century, when it was used extensively to study neurobiological processes and nervous system functioning. This carreer-time effort lead to a detailed description of the buccal ganglia 
