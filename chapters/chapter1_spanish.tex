...
\begin{figure}[htb!]
	...
	\caption{Representación de las neuronas del cerebelo por Ramón y Cajal.}
	\label{cajal-neuron spanish}
\end{figure}
...
% Como se mencionó, hay muchas formas diferentes de estudiar la dinámica neural, pero un descriptor común de la actividad neural son los potenciales de acción. Los potenciales de acción son el
