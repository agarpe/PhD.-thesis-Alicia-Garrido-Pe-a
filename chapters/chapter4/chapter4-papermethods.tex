...
In our analysis of variability, we assess the presence of linear relationships between the intervals that build the sequence and the cycle-by-cycle period to characterize and unveil similar dynamical invariants as those found in the stomatogastric CPG \textcite{elices_robust_2019}. 
...
\subsubsection{LP model by \textcite{nowotny_probing_2008}}
...
\subsubsection{Non chaotic model \textcite{ghigliazza_minimal_2004}}
