...
\begin{figure}[hbt!]
	...
	\begin{minipage}[b]{0.53\textwidth}
		...
		\end{minipage}
	\end{minipage}
	\caption{\textbf{N1M stimulation:} a) Box-plots of the  sequence intervals under N1M neuron stimulation. b) Interval correlations to period for N1M-driven simulation. First row: Burst durations. Second and third row: Two-neuron \textit{Intervals}. Forth and fifth row: Two-neuron \textbf{Delays}. Linear relationships are quantified by the $R^2$ values of the linear regression.}
