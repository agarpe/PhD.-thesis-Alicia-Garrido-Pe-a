...
\usepackage[backend=biber,style=alphabetic]{biblatex} % Use biblatex for bibliography
...
\begin{frame}
	...
	\frametitle{Slide 53 (not counted in total)}
    \setcounter{framenumber}{\value{framenumber} + 1}  % Increment to show as 53
	Content for frame 53.
\end{frame}

\begin{frame}
	\frametitle{Slide 54 (not counted in total)}
	\setcounter{framenumber}{\value{mainframecount}}  % Continue freezing the total at the last main frame
	Content for frame 54.
\end{frame}
