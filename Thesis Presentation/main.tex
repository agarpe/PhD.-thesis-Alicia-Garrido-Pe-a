...
\begin{frame}{Central Pattern Generators}
		...
		\movie[label=CPG activity, width=\textwidth, height=0.3\textwidth, poster=false, autostart=true, showcontrols=false, loop]
...
\begin{frame}{Temporal constrains: Sequential Dynamical invariants}
	...
	\begin{figure}[h!]
		\centering
		\movie[label=pyloric video,width=\textwidth, height=0.5\textheight,poster=false,autostart=true,showcontrols=false,loop]
...
\begin{frame}{Feeding CPG of \textit{Lymnaea stagnalis}}
	...
	\movie[label=cpg video,width=\textwidth, height=0.5\textheight,poster=false,autostart=true,showcontrols=false,loop]
