...
\begin{frame}{Experimental approach}
	...
	\begin{itemize}
		\item<1->Are sequential invariants present also in the experimental recordings? 
		\item<2->Do the invariants change under different stimulation conditions?\\
	\end{itemize}
	\vspace{7pt}
	\only<3>{
	...
	\only<4>{\small{This work was presented in: \fullcite{garrido-pena_universality_2021}}}
