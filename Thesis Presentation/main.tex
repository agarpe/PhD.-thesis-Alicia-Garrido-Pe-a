...
\usepackage[backend=biber,style=alphabetic,url=false]{biblatex} % Use biblatex for bibliography
...
%				\begin{column}{0.7\textwidth}
					\centering
					\uncover<7->{\includegraphics[width=0.2\textwidth]{Images/chemical_stim.pdf}}
					\uncover<8->{\includegraphics[width=0.2\textwidth]{Images/electrical_stim.pdf}}
					\\
					\uncover<9->{\includegraphics[width=0.2\textwidth]{Images/magnetic_stim.pdf}}
					\uncover<10->{\includegraphics[width=0.2\textwidth]{Images/mechanical_stim.pdf}}
