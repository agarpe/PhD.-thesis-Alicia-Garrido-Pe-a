...
\begin{frame}{References from two neurons}
	\includegraphics[width=0.7\textwidth]{methods-paper-modelo/Intervals_figure_complete_2_phases.png}	
	\includegraphics[width=0.7\textwidth]{methods-paper-modelo/Intervals_figure_complete.png}	
\end{frame}
