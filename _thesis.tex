...
backend=biber,
style=apa,
sortcites=true,   % Enable sorting of multiple citations in one \cite command
defernumbers=true,% Defer numbering until the bibliography is processed
backref=true,     % Enable backref
backrefstyle=none,% Control the format of the back references
hyperref=true,    % Enable hyperref
sorting=nyt,       % Set default sorting to nyt (name, year, title) for bibliography
firstinits=false,
uniquename=false,
uniquelist=false
]{biblatex}

% Apply the custom sorting scheme for in-text citations globally
%\AtEveryCitekey{\defcounter{maxnames}{200}} % Ensure all names are included in citations
\ExecuteBibliographyOptions{sorting=ynt}

% \addbibresource{own-bib.bib}
 \addbibresource{thesis_references_completaARREGLADA.bib}
...
\makeatother
\lfoot{\textit{A. Garrido Peña, PhD thesis}}
...
\regno{Doctorado en Ingeniería Informatica y de Telecomunicación}
...
\begin{document}
 ...
 \input{Preface/Resumen}


\clearpage
\newpage
\input{Preface/Agradecimientos}
...
\resetpagenumbering
 ...
 \input{chapters/chapter1_spanish}
...
\input{chapters/chapter4-invariants}
 ...
 \input{chapters/chapter6-conclusion_spanish}
